...
initMotion({"hero": ".headline > .eyebrow, .hero h1, .hero .intro, .hero .button", "art": ".hero figure", "reveal": ".visit-title h2, .steps article, .address h2", "artStart": "translateY(18px) scale(.97)"});
})();
